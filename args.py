...
group.add_argument('--n', type=int, default=60, help='number of sites')
...
group.add_argument(
    ...
    help='optimizer')
group.add_argument(
    '--batch_size', type=int, default=10000, help='number of samples')
group.add_argument('--lr', type=float, default=3*1e-2, help='learning rate')
group.add_argument(
    '--max_step', type=int, default=10**3, help='maximum number of steps')
group.add_argument(
    '--beta_anneal_to', type=float, default=1, help='final value of beta')
group.add_argument(
